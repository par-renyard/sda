...
import com.staples.sda.dialog.DialogContextStore;
...
public class SDAConsoleClient implements CommandLineRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		context = new AnnotationConfigApplicationContext(SDAConsoleClient.class);
	...
	public OutputChannel outputChannel() {
		return new OutputChannel() {
			...
			public void transferToAgent(MessageContext lastMessage) {
				...
				dialogContextStore.removeDialogContext(lastMessage.getMessage().getConversationId());
				System.exit(0);
			}
