...
public class SettingsService {
	...
	public <T> T getValue(String value, States state, Class<T> type) {
		T obj = env.getProperty(value + "." + state.name(), type);
		if (obj == null) {
	 ...
	 */
	public boolean isAgentAction(String value, States state) {
